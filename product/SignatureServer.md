...
[release tool](https://github.com/ontio/ontology/releases)
[Sigsvr_Exchange_Guide](https://github.com/ontio/documentation/blob/master/exchangeDocs/Sigsvr_Exchange_Guide.md)
Name: Ontology Signature Server 
Brief Desc: Ontology Signature Server is a rpc server for signing transactions.
product page:
get start:
document:
...
**Ontology Signature Server** is a rpc server for signing transactions.SignServer is available for Windows, Mac, and Linux.


### Installation 


[Download tool](https://github.com/ontio/ontology/releases) the appropriate version for your OS:

* Windows: tool-windows.zip
* Mac: tool-darwin.zip
* Linux: tool-linux.zip
